...
/*   Updated: 2025/01/23 15:41:44 by isrkik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d_bonus.h"

void	gwt_util(t_game *game, t_ray *ray, double *tex_x)
{
	int	tile_x;
	int	tile_y;
	...
	if (game->pars->map[tile_y][tile_x - 1] == 'D'
...
void	get_wall_texture(t_game *game, t_ray *ray, double *tex_x)
{
	...
	if (ray->horz < ray->vert)
	{
		...
		if (game->pars->map[tile_y - 1][tile_x] == 'D'
			|| game->pars->map[tile_y][tile_x] == 'D')
			ray->wall_texture = game->textures.door;
